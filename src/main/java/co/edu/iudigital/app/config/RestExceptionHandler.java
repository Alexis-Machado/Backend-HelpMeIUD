...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Maneja excepciones generales (Exception)
    ...
    // Maneja excepciones de tipo InternalServerErrorException
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    // Maneja excepciones relacionadas con argumentos de métodos no válidos
    @Override
